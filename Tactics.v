...
Proof.
  ...
  - reflexivity.
  - simpl. intros n. destruct n as [].
    + simpl. intros H. discriminate H.
    + simpl. intros H. injection H. apply Hl'.
Qed.
(** [] *)
...
Proof.
  ...
  - simpl.
    ...
    reflexivity.
  - intros l1 l2.
    destruct l1 as [| h1 l1'], l2 as [| h2 l2'].
    + simpl. destruct h. destruct (split l'). intros H. discriminate H.
    + simpl. destruct h. destruct (split l'). intros H. discriminate H.
    + simpl. destruct h. destruct (split l'). intros H. discriminate H.
    + simpl. destruct h. destruct (split l').
      intros H. injection H as H1 H2 H3 H4.
      rewrite -> H1. rewrite -> H3.
      assert (H6: combine l1' l2' = l').
      { apply Hl'.  rewrite -> H2. rewrite H4. reflexivity. }
      rewrite -> H6.
      reflexivity.
Qed.
(** [] *)
...
Proof.
  intros f b.
  destruct (f true) eqn:H1, (f false) eqn:H2, b as [].
...
Example test_forallb_4 : forallb (LF.Basics.eqb 5) [] = true.
Proof. reflexivity. Qed.
...
Example test_existsb_1 : existsb (LF.Basics.eqb 5) [0;2;3;6] = false.
Proof. reflexivity. Qed.
